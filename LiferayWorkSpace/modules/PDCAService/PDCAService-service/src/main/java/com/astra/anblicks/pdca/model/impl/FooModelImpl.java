...
import com.astra.anblicks.pdca.model.FooModel;
import com.astra.anblicks.pdca.model.FooSoap;
...
/**
 * The base model implementation for the Foo service. Represents a row in the &quot;astra_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	 ...
	 */
	public static final String TABLE_NAME = "astra_Foo";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.astra.anblicks.pdca.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.astra.anblicks.pdca.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.astra.anblicks.pdca.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.astra.anblicks.pdca.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.astra.anblicks.pdca.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.astra.anblicks.pdca.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.astra.anblicks.pdca.service.util.ServiceProps.get(
				"lock.expiration.time.com.astra.anblicks.pdca.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("com.astra.anblicks.pdca.model.Foo");
