...
/**
 * Provides the local service interface for Testmonials. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TestmonialsLocalServiceUtil
...
public interface TestmonialsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestmonialsLocalServiceUtil} to access the testmonials local service. Add custom service methods to {@link com.leykartservice.service.impl.TestmonialsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Testmonials fetchTestmonialsByUuidAndCompanyId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Testmonials getTestmonialsByUuidAndCompanyId(java.lang.String uuid,
