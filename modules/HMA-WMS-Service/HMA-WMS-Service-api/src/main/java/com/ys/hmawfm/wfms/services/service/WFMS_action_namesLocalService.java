...
/**
 * Provides the local service interface for WFMS_action_names. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WFMS_action_namesLocalServiceUtil
...
public interface WFMS_action_namesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WFMS_action_namesLocalServiceUtil} to access the WFMS_action_names local service. Add custom service methods to {@link com.ys.hmawfm.wfms.services.service.impl.WFMS_action_namesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WFMS_action_names addWFMS_action_names(
	...
	*/
	public WFMS_action_names createWFMS_action_names(java.lang.String actionId);
	...
	*/
	...
	public WFMS_action_names deleteWFMS_action_names(
		WFMS_action_names wfms_action_names);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WFMS_action_names deleteWFMS_action_names(java.lang.String actionId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WFMS_action_names fetchWFMS_action_names(java.lang.String actionId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WFMS_action_names getWFMS_action_names(java.lang.String actionId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WFMS_action_names updateWFMS_action_names(
		WFMS_action_names wfms_action_names);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WFMS_action_names> getWFMS_action_nameses(int start, int end);
