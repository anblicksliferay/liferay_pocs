...
/**
 * Provides the local service interface for WFMS_COS_Audit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WFMS_COS_AuditLocalServiceUtil
...
public interface WFMS_COS_AuditLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WFMS_COS_AuditLocalServiceUtil} to access the WFMS_COS_Audit local service. Add custom service methods to {@link com.ys.hmawfm.wfms.services.service.impl.WFMS_COS_AuditLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WFMS_COS_Audit addWFMS_COS_Audit(WFMS_COS_Audit wfms_cos_Audit);
	...
	*/
	public WFMS_COS_Audit createWFMS_COS_Audit(java.lang.String cosaId);
	...
	*/
	...
	public WFMS_COS_Audit deleteWFMS_COS_Audit(WFMS_COS_Audit wfms_cos_Audit);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WFMS_COS_Audit deleteWFMS_COS_Audit(java.lang.String cosaId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WFMS_COS_Audit fetchWFMS_COS_Audit(java.lang.String cosaId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WFMS_COS_Audit getWFMS_COS_Audit(java.lang.String cosaId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WFMS_COS_Audit updateWFMS_COS_Audit(WFMS_COS_Audit wfms_cos_Audit);
	...
	*/
	...
	public List<WFMS_COS_Audit> findByCosIdForAudit(java.lang.String cosId)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WFMS_COS_Audit> getWFMS_COS_Audits(int start, int end);
