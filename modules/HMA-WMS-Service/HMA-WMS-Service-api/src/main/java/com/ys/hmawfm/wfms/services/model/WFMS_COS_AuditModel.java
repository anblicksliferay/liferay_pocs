...
/**
 * The base model interface for the WFMS_COS_Audit service. Represents a row in the &quot;WFMS_COS_Audit&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.ys.hmawfm.wfms.services.model.impl.WFMS_COS_AuditModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.ys.hmawfm.wfms.services.model.impl.WFMS_COS_AuditImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface WFMS_COS_AuditModel extends BaseModel<WFMS_COS_Audit> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a WFMS_COS_Audit model instance should use the {@link WFMS_COS_Audit} interface instead.
	 */
