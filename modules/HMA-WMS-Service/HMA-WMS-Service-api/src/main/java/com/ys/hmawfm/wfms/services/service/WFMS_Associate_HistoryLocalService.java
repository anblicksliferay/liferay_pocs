...
/**
 * Provides the local service interface for WFMS_Associate_History. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WFMS_Associate_HistoryLocalServiceUtil
...
public interface WFMS_Associate_HistoryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WFMS_Associate_HistoryLocalServiceUtil} to access the WFMS_Associate_History local service. Add custom service methods to {@link com.ys.hmawfm.wfms.services.service.impl.WFMS_Associate_HistoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WFMS_Associate_History addWFMS_Associate_History(
	...
	*/
	public WFMS_Associate_History createWFMS_Associate_History(
		int assocHistoryId);
	...
	*/
	...
	public WFMS_Associate_History deleteWFMS_Associate_History(
		WFMS_Associate_History wfms_Associate_History);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WFMS_Associate_History deleteWFMS_Associate_History(
		int assocHistoryId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WFMS_Associate_History fetchWFMS_Associate_History(
		int assocHistoryId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WFMS_Associate_History getWFMS_Associate_History(int assocHistoryId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WFMS_Associate_History updateWFMS_Associate_History(
		WFMS_Associate_History wfms_Associate_History);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WFMS_Associate_History> getWFMS_Associate_Histories(int start,
		int end);
