...
/**
 * Provides the local service interface for WFMS_Position_Audit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see WFMS_Position_AuditLocalServiceUtil
...
public interface WFMS_Position_AuditLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WFMS_Position_AuditLocalServiceUtil} to access the WFMS_Position_Audit local service. Add custom service methods to {@link com.ys.hmawfm.wfms.services.service.impl.WFMS_Position_AuditLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public WFMS_Position_Audit addWFMS_Position_Audit(
	...
	*/
	public WFMS_Position_Audit createWFMS_Position_Audit(java.lang.String paId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WFMS_Position_Audit deleteWFMS_Position_Audit(java.lang.String paId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WFMS_Position_Audit fetchWFMS_Position_Audit(java.lang.String paId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WFMS_Position_Audit getWFMS_Position_Audit(java.lang.String paId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WFMS_Position_Audit updateWFMS_Position_Audit(
		WFMS_Position_Audit wfms_Position_Audit);
	...
	*/
	...
	public List<WFMS_Position_Audit> findByPosIdForAudit(java.lang.String pId)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WFMS_Position_Audit> getWFMS_Position_Audits(int start, int end);
