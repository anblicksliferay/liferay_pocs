...
<portlet:actionURL name="saveworkflowConfiguration" var="saveConfigurationURL"></portlet:actionURL>
<portlet:actionURL name="createworkflowConfiguration" var="createConfigurationURL"></portlet:actionURL>

<% WFMS_WorkflowConfig wfms_config = (WFMS_WorkflowConfig) request.getAttribute("wfms_workflow_config");%>
		...
		<aui:form action="<%= actionUrl %>" method="post">
			...
			<div class="portlet-column portlet-column-first col-sm-4">
				...
				<%} %>
					...
					<% if(wfms_config  != null){ %>
						<portlet:actionURL name="deleteworkflowConfiguration" var="deleteConfigurationURL">
