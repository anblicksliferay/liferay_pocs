...
public class DivisionService {
	...
	public DivisionService() {
		...
		serviceUrl = "/api/now/table/division_u";
	}

	public String getAllDivisions(String depId) throws  IOException {
	...
	public Map<String, String> getDivisionById(String divisionId) throws  IOException {

		Map<String, String> returnMap = new HashMap<String, String>();
		
		HttpEntity<String> entity = getHttpEntity();
	
		String getUrl = "https://" + host + serviceUrl + "?code="+divisionId;
		System.out.println("getUrl " + getUrl);
