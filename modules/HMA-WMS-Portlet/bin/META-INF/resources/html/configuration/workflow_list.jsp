...
<portlet:actionURL name="newworkflowConfiguration" var="newConfigurationURL"></portlet:actionURL>
<portlet:actionURL name="importView" var="importViewURL"></portlet:actionURL>	

<%
	List<WFMS_WorkflowConfig> configurationList = (List<WFMS_WorkflowConfig>) request.getAttribute("wfms_workflow_list");
%>
...
<div class="portlet-layout row">
	...
	<div class="col-sm-6">
		<div class="btn-manage small">
			...
			<div class="portlet-layout row">
				<input type="button" class="btn btn-primary" value="Create New Configuration" onclick="getUrl('<%=newConfigurationURL%>')">
	...
	<table id="recordList" class="display" cellspacing="0" width="100%">
        <thead>
			...
			<% for(WFMS_WorkflowConfig wmsConfig: configurationList){ %>
				...
				<portlet:actionURL name="manageworkflowConfiguration" var="manageConfigurationURL">
