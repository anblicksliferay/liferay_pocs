...
public class locationWrapper implements location, ModelWrapper<location> {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.servicemapping.model.location> toCacheModel() {
		return _location.toCacheModel();
	}

	@Override
	public com.servicemapping.model.location toEscapedModel() {
		return new locationWrapper(_location.toEscapedModel());
	}

	@Override
	public com.servicemapping.model.location toUnescapedModel() {
		return new locationWrapper(_location.toUnescapedModel());
	}

	@Override
	public int compareTo(com.servicemapping.model.location location) {
