...
import com.servicemapping.model.impl.locationImpl;
import com.servicemapping.model.impl.locationModelImpl;
 ...
 * @see com.servicemapping.service.persistence.locationUtil
 * @generated
 */
@ProviderType
public class locationPersistenceImpl extends BasePersistenceImpl<location>
	...
	public location updateImpl(location location) {
		...
		if (!locationModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else
		 if (isNew) {
			Object[] args = new Object[] { locationModelImpl.getUuid() };
	...
	protected TableMapper<location, com.servicemapping.model.course> locationTocourseTableMapper;
