...
package com.ys.hma.account.service.persistence;
 ...
 * @see DataPersistence
 * @see com.ys.hma.account.service.persistence.impl.DataPersistenceImpl
 * @generated
 */
@ProviderType
public class DataUtil {
	...
	* @return the new data
	*/
	public static Data create(long DataId) {
	...
	*/
	public static Data remove(long DataId)
		throws com.ys.hma.account.exception.NoSuchDataException {
	...
	* @throws NoSuchDataException if a data with the primary key could not be found
	*/
	public static Data findByPrimaryKey(long DataId)
		throws com.ys.hma.account.exception.NoSuchDataException {
	...
	*/
	public static Data fetchByPrimaryKey(long DataId) {
	...
	*/
	...
	private static ServiceTracker<DataPersistence, DataPersistence> _serviceTracker =
		ServiceTrackerFactory.open(DataPersistence.class);
}