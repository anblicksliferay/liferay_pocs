 ...
 * @see CountryModel
 * @see com.ys.hma.account.model.impl.CountryImpl
 * @see com.ys.hma.account.model.impl.CountryModelImpl
 * @generated
 */
@ImplementationClassName("com.ys.hma.account.model.impl.CountryImpl")
@ProviderType
public interface Country extends CountryModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.ys.hma.account.model.impl.CountryImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
