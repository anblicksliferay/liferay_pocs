...
/**
 * Provides the local service interface for Data. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DataLocalServiceUtil
...
public interface DataLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DataLocalServiceUtil} to access the data local service. Add custom service methods to {@link com.ys.hma.account.service.impl.DataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
