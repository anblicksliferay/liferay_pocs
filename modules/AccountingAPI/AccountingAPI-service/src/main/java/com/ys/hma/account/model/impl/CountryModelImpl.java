...
import com.ys.hma.account.model.CountryModel;
import com.ys.hma.account.model.CountrySoap;
...
public class CountryModelImpl extends BaseModelImpl<Country>
	...
	public static final String TABLE_SQL_CREATE = "create table country (countryId LONG not null primary key,countryName VARCHAR(75) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.ys.hma.account.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.ys.hma.account.model.Country"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.ys.hma.account.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.ys.hma.account.model.Country"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.ys.hma.account.service.util.ServiceProps.get(
				"lock.expiration.time.com.ys.hma.account.model.Country"));
	...
	public String toXmlString() {
		...
		sb.append("com.ys.hma.account.model.Country");
