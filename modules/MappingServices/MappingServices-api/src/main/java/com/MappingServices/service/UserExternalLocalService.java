...
/**
 * Provides the local service interface for UserExternal. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserExternalLocalServiceUtil
...
public interface UserExternalLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserExternalLocalServiceUtil} to access the user external local service. Add custom service methods to {@link com.MappingServices.service.impl.UserExternalLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
