...
import com.ab.all.model.FooModel;
import com.ab.all.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.ab.all.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.ab.all.model.Foo"), true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.ab.all.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.ab.all.model.Foo"), true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.ab.all.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.ab.all.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.ab.all.service.util.ServiceProps.get(
				"lock.expiration.time.com.ab.all.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("com.ab.all.model.Foo");
