...
import com.all.ddtiservice.model.impl.courseImpl;
import com.all.ddtiservice.model.impl.courseModelImpl;
 ...
 * @see com.all.ddtiservice.service.persistence.courseUtil
 * @generated
 */
@ProviderType
public class coursePersistenceImpl extends BasePersistenceImpl<course>
	 ...
	 */
	@Override
	public List<com.all.ddtiservice.model.location> getlocations(long pk) {
	...
	public List<com.all.ddtiservice.model.location> getlocations(long pk,
		int start, int end,
		OrderByComparator<com.all.ddtiservice.model.location> orderByComparator) {
	...
	public void addlocations(long pk,
		List<com.all.ddtiservice.model.location> locations) {
		addlocations(pk,
			ListUtil.toLongArray(locations,
				com.all.ddtiservice.model.location.LOCATION_ID_ACCESSOR));
	}
	...
	public void setlocations(long pk,
		...
		try {
			...
			for (int i = 0; i < locations.size(); i++) {
				com.all.ddtiservice.model.location location = locations.get(i);
	 ...
	 */
	@Override
	public List<com.all.ddtiservice.model.registrationDetails> getregistrationDetailses(
		long pk) {
	...
	public List<com.all.ddtiservice.model.registrationDetails> getregistrationDetailses(
		long pk, int start, int end,
		OrderByComparator<com.all.ddtiservice.model.registrationDetails> orderByComparator) {
	...
	public void addregistrationDetailses(long pk,
		List<com.all.ddtiservice.model.registrationDetails> registrationDetailses) {
		addregistrationDetailses(pk,
			ListUtil.toLongArray(registrationDetailses,
				com.all.ddtiservice.model.registrationDetails.REGISTRATION_ID_ACCESSOR));
	}
	...
	protected TableMapper<course, com.all.ddtiservice.model.location> courseTolocationTableMapper;
	...
	protected TableMapper<course, com.all.ddtiservice.model.registrationDetails> courseToregistrationDetailsTableMapper;
