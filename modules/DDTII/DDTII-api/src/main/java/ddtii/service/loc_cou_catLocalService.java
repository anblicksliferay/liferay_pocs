...
/**
 * Provides the local service interface for loc_cou_cat. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see loc_cou_catLocalServiceUtil
...
public interface loc_cou_catLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link loc_cou_catLocalServiceUtil} to access the loc_cou_cat local service. Add custom service methods to {@link ddtii.service.impl.loc_cou_catLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public loc_cou_cat addloc_cou_cat(loc_cou_cat loc_cou_cat);
	...
	*/
	public loc_cou_cat createloc_cou_cat(long loc_cou_catId);
	...
	*/
	...
	public loc_cou_cat deleteloc_cou_cat(loc_cou_cat loc_cou_cat);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public loc_cou_cat deleteloc_cou_cat(long loc_cou_catId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public loc_cou_cat fetchloc_cou_cat(long loc_cou_catId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public loc_cou_cat getloc_cou_cat(long loc_cou_catId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public loc_cou_cat updateloc_cou_cat(loc_cou_cat loc_cou_cat);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<loc_cou_cat> getloc_cou_cats(int start, int end);
