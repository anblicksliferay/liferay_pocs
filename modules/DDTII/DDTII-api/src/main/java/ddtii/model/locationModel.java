...
/**
 * The base model interface for the location service. Represents a row in the &quot;DDTII_location&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link ddtii.model.impl.locationModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ddtii.model.impl.locationImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface locationModel extends AuditedModel, BaseModel<location>,
	ShardedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	@Override
	public CacheModel<ddtii.model.location> toCacheModel();
