...
/**
 * Provides the local service interface for FAQSAshok. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FAQSAshokLocalServiceUtil
...
public interface FAQSAshokLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FAQSAshokLocalServiceUtil} to access the f a q s ashok local service. Add custom service methods to {@link com.ddt.service.impl.FAQSAshokLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
