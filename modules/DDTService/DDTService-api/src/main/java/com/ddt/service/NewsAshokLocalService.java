...
/**
 * Provides the local service interface for NewsAshok. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NewsAshokLocalServiceUtil
...
public interface NewsAshokLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NewsAshokLocalServiceUtil} to access the news ashok local service. Add custom service methods to {@link com.ddt.service.impl.NewsAshokLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
