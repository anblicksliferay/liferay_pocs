...
/**
 * Provides the local service utility for FAQSAshok. This utility wraps
 * {@link com.ddt.service.impl.FAQSAshokLocalServiceImpl} and is the
 ...
 * @see com.ddt.service.base.FAQSAshokLocalServiceBaseImpl
 * @see com.ddt.service.impl.FAQSAshokLocalServiceImpl
 * @generated
 */
@ProviderType
public class FAQSAshokLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.ddt.service.impl.FAQSAshokLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.ddt.model.FAQSAshok addFAQSAshok(
		com.ddt.model.FAQSAshok faqsAshok) {
		return getService().addFAQSAshok(faqsAshok);
	}
	...
	*/
	public static com.ddt.model.FAQSAshok createFAQSAshok(long id) {
		return getService().createFAQSAshok(id);
	}
	...
	*/
	public static com.ddt.model.FAQSAshok deleteFAQSAshok(
		com.ddt.model.FAQSAshok faqsAshok) {
		return getService().deleteFAQSAshok(faqsAshok);
	}
	...
	*/
	public static com.ddt.model.FAQSAshok deleteFAQSAshok(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteFAQSAshok(id);
	}

	public static com.ddt.model.FAQSAshok fetchFAQSAshok(long id) {
		return getService().fetchFAQSAshok(id);
	}
	...
	* @throws PortalException if a f a q s ashok with the primary key could not be found
	*/
	public static com.ddt.model.FAQSAshok getFAQSAshok(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getFAQSAshok(id);
	}
	...
	*/
	public static com.ddt.model.FAQSAshok updateFAQSAshok(
		com.ddt.model.FAQSAshok faqsAshok) {
		return getService().updateFAQSAshok(faqsAshok);
	}
	...
	*/
	public static int getFAQSAshoksCount() {
		return getService().getFAQSAshoksCount();
	}
	...
	*/
	public static java.util.List<com.ddt.model.FAQSAshok> getFAQSAshoks(
		int start, int end) {
		return getService().getFAQSAshoks(start, end);
	}
	...
	*/
	...
	public static FAQSAshokLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<FAQSAshokLocalService, FAQSAshokLocalService> _serviceTracker =
		ServiceTrackerFactory.open(FAQSAshokLocalService.class);
}