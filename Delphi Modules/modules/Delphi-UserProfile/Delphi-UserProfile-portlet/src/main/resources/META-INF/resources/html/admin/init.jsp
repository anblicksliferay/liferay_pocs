...
<%@ page import="com.delphi.userprofile.service.UserProfileLocalServiceUtil" %>
...
<%
	List<UserAccessRequest> userAccessRequests = (List <UserAccessRequest>)renderRequest.getAttribute("userAccessRequest");
	List<User> users = (List <User>)renderRequest.getAttribute("siteUsers");
