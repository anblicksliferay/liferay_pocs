...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/switchery.min.css" >
 ...
 <script src="<%=request.getContextPath()%>/js/select2/js/select2-modified.js" ></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/js/select2/css/select2.css" >
...
<%
	...
	if(null!=HttpUtil.getParameterMap(url).get("code")){
		param_code = HttpUtil.getParameterMap(url).get("code")[0] ;
		System.out.println("[param_code] used :"+param_code);
	}
%>