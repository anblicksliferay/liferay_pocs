...
<div class="delphi-guh">
	<form name="findGUHForm" id="findGUHForm" method="post" name="findGUH">
		<div class="row controlbg" align="center">
			<div class="col-md-5">
				<span class="data-title"><liferay-ui:message key="delphi-globalunithistory-portlet.unit" /></span>
			</div>
			<div class="col-md-7">
			</div>
		</div>
		<div class="row controlbg" align="center">
			<div class="col-md-5">
				<select class="select-barcodes form-control" id="barCodeSelect" multiple="multiple">
				  <optgroup id="userselect-codes-queued" label="<liferay-ui:message key="delphi-globalunithistory-portlet.viewed-on-server-colon" />"></optgroup>
				  <optgroup id="userselect-codes-today" label="<liferay-ui:message key="delphi-globalunithistory-portlet.viewed-today-colon" />"></optgroup>
				  <optgroup id="userselect-codes-week" label="<liferay-ui:message key="delphi-globalunithistory-portlet.viewed-earlier-this-week-colon" />"></optgroup>
				  <optgroup id="userselect-codes-saved" label="<liferay-ui:message key="delphi-globalunithistory-portlet.saved-colon" />"></optgroup>
				</select>
			</div>
	...
	<div class="controlbg" id="barCodeListWrapper">
		<h3><liferay-ui:message key="delphi-globalunithistory-portlet.recent" /> <i class="fa arrow"></i></h3>
		<div id="barCodeList" class="row" style="display:none">
			<div class="col-sm-4">
				<div class="barCodeList-wrapper">
					<h4 class="active"><liferay-ui:message key="delphi-globalunithistory-portlet.queued-on-server" /> <i class="fa arrow"></i></h4>
					<div class="list" id="barCodeList-queued"></div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="barCodeList-wrapper">
					<h4 class="active"><liferay-ui:message key="delphi-globalunithistory-portlet.viewed-today" /> <i class="fa arrow"></i></h4>
					<div class="list" id="barCodeList-today"></div>
				</div>
				<div class="barCodeList-wrapper">
					<h4 class="active"><liferay-ui:message key="delphi-globalunithistory-portlet.viewed-earlier-this-week" /> <i class="fa arrow"></i></h4>
					<div class="list" id="barCodeList-week"></div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="barCodeList-wrapper">
					<h4 class="active"><liferay-ui:message key="delphi-globalunithistory-portlet.saved" /> <i class="fa arrow"></i></h4>
	...
	<div style="padding:5px;"><i><liferay-ui:message key="delphi-globalunithistory-portlet.guh-display-message" /></i></div>
</div>
...
<script>
	...
	function initGUHLogic(){
		...
		$(".select-barcodes").select2({
			placeholder: "<liferay-ui:message key='delphi-globalunithistory-portlet.type-or-select' />",
	...
	function initGUH(unitHistory, multiple){
		...
		if(multiple === 'true'){
			delphiGUHdata.innerHTML =	"<center class='data-title rework' style='margin: 20px;padding:10px;'>" +
										"<liferay-ui:message key="delphi-globalunithistory-portlet.history-not-displayed" /> <a href='mailto:steven.f.hutchins@aptiv.com?Subject=Duplicate%20serial%20number%20found%20for%20" +getBarCodeSelection()+"' target='_top'>steven.f.hutchins@aptiv.com</a>.</center>" ;
		...
		if(!unitHistory.length){
			delphiGUHdata.innerHTML =	"<center class='data-title rework' style='margin: 20px;padding:10px;'>" +
										"<liferay-ui:message key="delphi-globalunithistory-portlet.unable-retrieve" />"	+						
										"</center>" ;
			delphiGUHMobiledata.innerHTML = delphiGUHdata.innerHTML;
			return;
		};
		...
		tableDetail.className="grid table mobile-guh-hide";
			...
			var tablebody = document.createElement("tbody");
				...
				tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.route-key" />" ) );
				tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.product-family" />") );
				tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.part-number" />") );
				tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.product-type" />") );
				tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.site" />") );
				tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.server" />") );
		...
		tableDetail.className="grid table";
			...
			var tablebody = document.createElement("tbody");
				...
				tablerow.appendChild( createDomElemement("td", "<b><liferay-ui:message key="delphi-globalunithistory-portlet.route-key-colon" /></b>" ) );
				tablerow.appendChild( createDomElemement("td", unitHistory[0]["routeKey"] ) );
				tablebody.appendChild(tablerow);
				...
				tablerow.appendChild( createDomElemement("td", "<b><liferay-ui:message key="delphi-globalunithistory-portlet.product-family-colon" /></b>" ) );
				tablerow.appendChild( createDomElemement("td", unitHistory[0]["productType"] ) );
				tablebody.appendChild(tablerow);
				...
				tablerow.appendChild( createDomElemement("td", "<b><liferay-ui:message key="delphi-globalunithistory-portlet.part-number-colon" /></b>" ) );
				tablerow.appendChild( createDomElemement("td", unitHistory[0]["partNumber"] ) );
				tablebody.appendChild(tablerow);
				...
				tablerow.appendChild( createDomElemement("td", "<b><liferay-ui:message key="delphi-globalunithistory-portlet.product-type-colon" /></b>" ) );
				tablerow.appendChild( createDomElemement("td", unitHistory[0]["productType"] ) );
				tablebody.appendChild(tablerow);
				...
				tablerow.appendChild( createDomElemement("td", "<b><liferay-ui:message key="delphi-globalunithistory-portlet.site-colon" /></b>" ) );
				tablerow.appendChild( createDomElemement("td", unitHistory[0]["location"] ) );
				tablebody.appendChild(tablerow);
				...
				tablerow.appendChild( createDomElemement("td", "<b><liferay-ui:message key="delphi-globalunithistory-portlet.server-colon" /></b>" ) );
				tablerow.appendChild( createDomElemement("td", unitHistory[0]["serverName"] ) );
				tablebody.appendChild(tablerow);
				...
				tablerow.appendChild( createDomElemement("td", "<b><liferay-ui:message key="delphi-globalunithistory-portlet.parent" /> <span id='parentCount'></span>:</b>" ) );
				...
				tablerow.appendChild( createDomElemement("td", "<b><liferay-ui:message key="delphi-globalunithistory-portlet.children" /> <span id='childCount'></span>:</b>" ) );
		...
		/* Desktop Data Table */
			...
			var tablebody = document.createElement("tbody");
				...
				var processTh = createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.process" />" );
				processTh.className = "process-title";
		
					tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.event" />" ) );
					tablerow.appendChild( processTh );
					tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.station" />") );
					tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.status" />") );
					tablerow.appendChild( createDomElemement("th", "<liferay-ui:message key="delphi-globalunithistory-portlet.data" />", 1, 2) );
				...
				for(i=0;i<unitHistory.length;i++){
					...
					if(unitHistory[i]["status"]==='<liferay-ui:message key="delphi-globalunithistory-portlet.scrap" />'){
						tablerow.className="scrap";
					}else if(unitHistory[i]["status"]==='<liferay-ui:message key="delphi-globalunithistory-portlet.pass" />'){
						tablerow.className="pass";
					}else if(unitHistory[i]["status"]==='<liferay-ui:message key="delphi-globalunithistory-portlet.rework" />'){
		...
		mobileTitleData.className="background-title-guh d-flex";
			...
			mobileDataChild1.className="mw-45 p-10 border-guh ";
				...
				$(mobileDataP1).text("<liferay-ui:message key="delphi-globalunithistory-portlet.process" />");
				
				var mobileDataP2 = document.createElement("p");
				mobileDataP2.className="guh";
				$(mobileDataP2).text("<liferay-ui:message key="delphi-globalunithistory-portlet.station" />");
				
				var mobileDataP3 = document.createElement("p");
				mobileDataP3.className="guh w-s";
				$(mobileDataP3).text("<liferay-ui:message key="delphi-globalunithistory-portlet.event" />");
			...
			mobileDataChild2.className="mw-55 p-10 border-guh d-flex";
				...
				$(mobileDataP1).text("<liferay-ui:message key="delphi-globalunithistory-portlet.data" />");
