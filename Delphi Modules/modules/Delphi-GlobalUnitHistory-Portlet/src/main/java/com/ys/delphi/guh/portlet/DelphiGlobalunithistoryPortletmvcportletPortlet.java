package com.ys.delphi.guh.portlet;
...
import com.ys.delphi.guh.service.impl.GUHServiceImpl;
import com.ys.delphi.guh.util.GUHUtils;
...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=Delphi",
		"com.liferay.portlet.instanceable=true", "com.liferay.portlet.header-portlet-javascript=/js/main.js",
		"javax.portlet.display-name=Delphi-GlobalUnitHistory-Portlet Portlet",
...
public class DelphiGlobalunithistoryPortletmvcportletPortlet extends MVCPortlet {
	private static Log _log = LogFactoryUtil.getLog(DelphiGlobalunithistoryPortletmvcportletPortlet.class);
